...
**
*******************************************************************************/
static uint8_t _send_result_to_hf (hfp_ag_session_cb_t *p_scb, UINT8 code, char *p_arg, INT16 int_arg)
{
...
**
*******************************************************************************/
static void _send_OK_to_hf (hfp_ag_session_cb_t *p_scb)
{
...
**
*******************************************************************************/
static void _send_error_to_hf (hfp_ag_session_cb_t *p_scb, INT16 errcode)
{
...
**
*******************************************************************************/
static void _parse_bac_command (hfp_ag_session_cb_t *p_scb, char *p_s)
{
    UINT16              codec;
...
**
*******************************************************************************/
static void _handle_command_from_hf (hfp_ag_session_cb_t *p_scb, UINT16 cmd, UINT8 arg_type, char *p_arg, INT16 int_arg)
{
    UINT32      i;
#if (BTM_WBS_INCLUDED == TRUE )
    UINT16      codec_type;
...
/*******************************************************************************
**
** Function         hfp_ag_send_BVRA_to_hf
**
...
**
*******************************************************************************/
void hfp_ag_send_BVRA_to_hf (hfp_ag_session_cb_t *p_scb, BOOLEAN b_is_active)
{
    _send_result_to_hf (p_scb, BTA_AG_RES_BVRA, NULL, b_is_active ? 1 : 0);
}

void hfp_ag_send_RING_to_hf (hfp_ag_session_cb_t *p_scb)
{
    _send_result_to_hf (p_scb, BTA_AG_RES_RING, NULL, 0);
}

uint8_t hfp_ag_send_VGM_to_hf (hfp_ag_session_cb_t *p_scb, INT16 gain)
{
    return _send_result_to_hf (p_scb, BTA_AG_RES_VGM, NULL, gain);
}

uint8_t hfp_ag_send_VGS_to_hf (hfp_ag_session_cb_t *p_scb, INT16 gain)
{
...
/*******************************************************************************
**
** Function         hfp_ag_send_BCS_to_hf
**
...
**
*******************************************************************************/
void hfp_ag_send_BCS_to_hf (hfp_ag_session_cb_t *p_scb)
{
    UINT16 codec_uuid;
...
**
******************************************************************************/
void hfp_ag_parse_AT_command (hfp_ag_session_cb_t *p_scb)
{
    int         i;
    UINT16      idx;
    UINT8       arg_type;
